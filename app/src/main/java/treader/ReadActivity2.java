...
import treader.db.BookMarks;
import treader.dialog.PageModeDialog;
import treader.dialog.SettingDialog;
import treader.util.BrightnessUtil;
...
//    LinearLayout ll_top;
    ...
    private PageFactory2 pageFactory;
            ...
            if (pageFactory.getCurrentPage() != null) {
                ...
                if (!bookMarksList.isEmpty()) {
                    ...
                    try {
                        ...
                        Toast.makeText(ReadActivity2.this, "书签添加成功", Toast.LENGTH_SHORT).show();
                    } catch (SQLException e) {
                        Toast.makeText(ReadActivity2.this, "该书签已存在", Toast.LENGTH_SHORT).show();
                    } catch (Exception e) {
                        Toast.makeText(ReadActivity2.this, "添加书签失败", Toast.LENGTH_SHORT).show();
                    }
                }
            }
